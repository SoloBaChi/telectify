    ...
    <main className="flex min-h-screen flex-col items-center justify-between ">
      ...
      <div className="justify-center lg:p-4">
        ...
        <p>
          ...
          state-of-the-art technology to provide users with a comprehensive view
          of their energy usage, enabling smarter decision-making, cost savings,
        ...
        <div className="mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 md:grid-cols-2 md:gap-4 lg:grid-cols-3 lg:text-left">
          ...
          <figure className="card group rounded-lg border border-transparent-800 p-2 mb-4 transition-colors hover:text-white cursor-pointer background-blue">
            ...
            <p className="text-sm opacity-50">
              ...
              clear and understandable format. Visualize your usage trends, peak
              hours, and areas for improvement effortlessly.
            </p>
          </figure>
          <figure className="card group rounded-lg border border-transparent-800 p-2 mb-4 transition-colors hover:text-white cursor-pointer background-blue">
        ...
        <div className="mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 md:grid-cols-2 md:gap-4 lg:grid-cols-3 lg:text-left">
          ...
          <figure className="card group rounded-lg border border-transparent-800 p-2 mb-4 transition-colors hover:text-white cursor-pointer background-blue">
            ...
            <p className="text-sm opacity-50">
              ...
              enterprise, Telectify scales to meet your energy monitoring needs.
              Our flexible platform adapts to different settings and
              requirements.
            </p>
          </figure>
        </div>
