...
export default function Signup() {
    return (
        ...
        <section className='w-4/5 lg:w-3/5 mx-auto'>
            ...
            <h3 className='mb-3 text-2xl font-bold text-left mt-8'>Create an account</h3>
            ...
            <div className="form-body">
                ...
                <div className="form-field">
                 ...
                 <p className='text-center mt-4 text-sm font-semibold'>Already not have an account <Link className='text-blue-600' href="/login">  Login</Link> </p>
            </div>
            </form>
        </section>
        </div>
